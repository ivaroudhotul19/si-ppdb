!(function (e, t) {
    ...
    const Te = [
            ...
            return e && t.icon === e.icon
                ...
                ? t.icon && -1 === Object.keys(S).indexOf(t.icon)
                    ? (y(
                      ...
                      h(n))
                    : (d(n), We(n, t), Ne(n, t), void u(n, t.showClass.icon))
                : h(n);
        },
        Ne = (e, t) => {
        ...
        tt = (e) => {
            const n = {};
            return (
                r(e.querySelectorAll("swal-param")).forEach((e) => {
                    ct(e, ["name", "value"]);
        ...
        nt = (e) => {
            const n = {};
            return (
                r(e.querySelectorAll("swal-button")).forEach((e) => {
        ...
        at = (e) => {
            ...
            t &&
                (ct(t, ["type", "label", "placeholder", "value"]),
    ...
    const pt = () => {
        ...
        yt = (e, t) => {
            Pe && ue(t)
                ? ((e.style.overflowY = "hidden"), t.addEventListener(Pe, vt))
        ...
        xt = (n) => {
            ...
            return (
                "undefined" != typeof Map && n instanceof Map
                    ? n.forEach((e, t) => {
                          let n = e;
                          "object" == typeof n && (n = xt(n)), o.push([t, n]);
                      })
                    : Object.keys(n).forEach((e) => {
                          let t = n[e];
                          "object" == typeof t && (t = xt(t)), o.push([e, t]);
                      }),
                o
            );
        },
            ...
            "function" == typeof n.willClose && n.willClose(t),
                s
                    ? ((s = e),
                      ...
                      (i = n.returnFocus),
                      (a = n.didClose),
                      (f.swalCloseEventFinishedCallback = Gt.bind(
                          null,
                          s,
                          t,
                          i,
    ...
    const rn = (e) => {
            e.isAwaitingPromise()
                ? (sn(b, e), b.awaitingPromise.set(e, !0))
                : (sn($t, e), sn(b, e));
        },
        sn = (e, t) => {
        ...
        _main(e) {
            var t =
                ...
                e =
                    (T(Object.assign({}, t, e)),
                    f.currentInstance &&
                        (f.currentInstance._destroy(), Y() && Qe()),
    ...
    const dn = (l, u, d) =>
            new Promise((e, t) => {
                          ...
                          (kt(V()), Pt(a, t));
                {
                    ...
                    "function" == typeof r.willOpen && r.willOpen(c),
                        ...
                        Y() && (wt(s, r.scrollbarPadding, e), Ge()),
                        Z() ||
        ...
        vn =
            (Object.assign(un.prototype, cn),
            Object.assign(un, e),
            Object.keys(cn).forEach((e) => {
                un[e] = function () {
                    if (ln) return ln[e](...arguments);
                };
            }),
            (un.DismissReason = $e),
            (un.version = "11.3.10"),
