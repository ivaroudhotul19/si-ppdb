...
@section('title')
    Edit Pembayaran {{ $payment->kd_bayar }}
@endsection
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header mt-3">
                <h4 class="card-title">Edit Input Pembayaran</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 mb-2">
                        <form action="/dashboard/payments/{{ $payment->id }}" method="post">
                            @method('put')
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="kd_bayar" id="kd_bayar" 
                                    ...
                                    placeholder="Enter nama" required value="{{ old('kd_bayar', $payment->kd_bayar) }}">
                                    @error('kd_bayar')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="tagihan" id="tagihan" 
                                    ...
                                    placeholder="Enter tagihan" required value="{{ old('tagihan', $payment->tagihan) }}">
                                    @error('tagihan')
                                        <div class="position-absolute mb-5 invalid-feedback">
                                        {{ $message }}
                                        </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="form-check-primary mb-4 mt-3">
                                    <div class="form-check form-check-inline">
                                        ...
                                        {{ old('status', $payment->status)=='Lunas' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        {{ old('status', $payment->status)=='Belum Lunas' ? 'checked' : '' }}>
