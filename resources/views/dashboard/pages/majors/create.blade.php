            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Input Jurusan</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12 mb-2">
                        <form action="/dashboard/majors" method="post">
                            @csrf
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="kd_jurusan" id="kd_jurusan" 
                                    ...
                                    placeholder="Enter kode jurusan" required value="{{ old('kd_jurusan') }}" 
                                    autofocus>
                                    @error('kd_jurusan')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="jurusan" id="jurusan" 
                                    ...
                                    placeholder="Enter jurusan" required value="{{ old('jurusan') }}">
                                    @error('jurusan')
                                        <div class="position-absolute mb-5 invalid-feedback">
                                        {{ $message }}
                                        </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="daya_tampung" id="daya_tampung" 
                                    ...
                                    placeholder="Enter daya tampung" required value="{{ old('daya_tampung') }}">
                                    @error('daya_tampung')
                                        <div class="position-absolute mb-5 invalid-feedback">
                                        {{ $message }}
                                        </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="thn_ajaran" id="thn_ajaran" 
                                    ...
                                    placeholder="Enter tahun ajaran" required value="{{ old('thn_ajaran') }}">
                                    @error('thn_ajaran')
                                        <div class="position-absolute mb-5 invalid-feedback">
                                            {{ $message }}
                                        </div>
