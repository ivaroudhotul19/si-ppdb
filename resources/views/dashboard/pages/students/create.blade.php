    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header mt-3">
                <h4 class="card-title">Form Input Siswa</h4>
            </div>
            <div class="card-body">
                <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="no_pendf" id="no_pendf" 
                                            ...
                                            placeholder="Enter nomor pendaftaran" required value="{{ old('no_pendf') }}">
                                            @error ('no_pendf')
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="name" id="name" 
                                            ...
                                            placeholder="Enter nama" required value="{{ old('name') }}">
                                            @error ('name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="asal_sklh" id="asal_sklh" 
                                            ...
                                            placeholder="Enter asal sekolah" required value="{{ old('asal_sklh') }}">
                                            @error ('asal_sklh')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="umur" id="umur" 
                                            ...
                                            placeholder="Enter umur" required value="{{ old('umur') }}">
                                            @error ('umur')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="agama" id="agama" 
                                            ...
                                            placeholder="Enter agama" required value="{{ old('agama') }}">
                                            @error ('agama')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                            ...
                            <div>
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="almt" id="almt" 
                                        ...
                                        placeholder="Enter alamat" required value="{{ old('almt') }}">
                                        @error ('almt')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="nama_ortu" id="nama_ortu" 
                                        ...
                                        placeholder="Enter nama orang tua" required value="{{ old('nama_ortu') }}">
                                        @error ('nama_ortu')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="pkerjaan_ortu" id="pkerjaan_ortu" 
                                        ...
                                        placeholder="Enter pekerjaan orang tua" required value="{{ old('pkerjaan_ortu') }}">
                                        @error ('pkerjaan_ortu')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="nilai_un" id="nilai_un" 
                                                ...
                                                placeholder="Enter nilai ujian nasional" required value="{{ old('nilai_un') }}">
                                                @error ('nilai_un')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="nilai_usek" id="nilai_usek" 
                                                ...
                                                placeholder="Enter nilai ujian sekolah" required value="{{ old('nilai_usek') }}">
                                                @error ('nilai_usek')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea type="text" name="prestasi" id="prestasi" class="form-control " rows="3"></textarea>
                                </div>
